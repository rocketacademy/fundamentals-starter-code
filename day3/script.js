 ...
 * Lucky 11
 */
var luckyEleven = function (guess) {
  var diceOne = rollDice();
  var diceTwo = rollDice();
  var sumOfDiceRolls = diceOne + diceTwo;
  if (diceOne == guess ||
      diceTwo == guess ||
      sumOfDiceRolls == 11) {
        return `You guessed ${guess} and rolled ${diceOne} and ${diceTwo}! You win!`;
      }
  return `You guessed ${guess} and rolled ${diceOne} and ${diceTwo}, you lost :(`;
}
 ...
 */
var hawkerFoodCategorisation = function (hawkerDishName) {
...
var fourDWithSingleDigitComparison = function (fourDGuess) {
...
var hawkerFoodRandomness = function (hawkerDishGuess) {
...
var fourDWithWinningRange = function (fourDGuess) {
...
var hawkerFoodOmakase = function (chosenBase) {
...
var main = function (input) {
  return fourD(input);
  // return hawkerFoodCategorisation(input);
  // return fourDWithSingleDigitComparison(input);
  // return hawkerFoodRandomness(input);
  // return fourDWithWinningRange(input);
  // return hawkerFoodOmakase(input);
};
